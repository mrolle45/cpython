...
def load_tokens(path):
    ...
    return tok_names, ERRORTOKEN, string_to_tok, ws_names
...
def make_h(infile, outfile='Include/token.h'):
    tok_names, ERRORTOKEN, string_to_tok, ws_names = load_tokens(infile)
...
__all__ = ['tok_name', 'ISTERMINAL', 'ISNONTERMINAL', 'ISWHITESPACE', 'ISEOF']
...
def make_py(infile, outfile='Lib/token.py'):
    ...
    ws_names = [name + ', ' for name in ws_names]
